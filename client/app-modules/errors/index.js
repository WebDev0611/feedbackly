...
function SurveyNotActiveError(message, details) {
  ApiError.call(this, message || 'No survey active', details || {});

  this.name = 'SurveyNotActiveError';
}

SurveyNotActiveError.prototype = Object.create(ApiError.prototype);
...
module.exports = { ApiError, NotFoundError, InvalidRequestError, ForbiddenError, withExistsOrError, SurveyNotActiveError }
